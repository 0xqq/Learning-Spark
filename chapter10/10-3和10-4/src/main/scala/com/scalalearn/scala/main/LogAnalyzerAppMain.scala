...
import com.scalalearn.java.main.ApacheAccessLog
import com.scalalearn.scala.main.{LogAnalyzerTotal, LogAnalyzerWindowed}
...
/**
  ...
  */
case class Config(WindowLength: Int = 1000, SlideInterval: Int = 3000, LogsDirectory: String = "file:///tmp/logs",
...
object LogAnalyzerAppMain {
  ...
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf()
      .setAppName("A Databricks Reference Application: Logs Analysis with Spark").setMaster("local[4]")
